...
export default function SetupPage({ store, showToast }) {
  ...
  return (
    <div className="py-6">
      <div className="mb-4 w-14 h-14 rounded-2xl overflow-hidden bg-white/5 flex items-center justify-center p-1"><img src="/logo.jpg" alt="logo" className="w-full h-full object-contain drop-shadow-lg" /></div>
